COPY company_dim
FROM '/private/tmp/Datasets/company_dim.csv'
DELIMITER ',' CSV HEADER;

COPY job_postings_fact
FROM '/private/tmp/Datasets/job_postings_fact.csv'
DELIMITER ',' CSV HEADER;

COPY skills_dim
FROM '/private/tmp/Datasets/skills_dim.csv'
DELIMITER ',' CSV HEADER;

COPY skills_job_dim
FROM '/private/tmp/Datasets/skills_job_dim.csv'
DELIMITER ',' CSV HEADER;
